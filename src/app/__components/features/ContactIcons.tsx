        ...
        <div className="py-2 flex sm:flex-col gap-4">
            {icons.map((Icon: IconType , index) => (
                <div key={index} className="group z-3">
                    ...
                    <Icon className="xl:text-[3rem] 2xl:text-[3.5rem] text-[3rem] reflect-icons transition-all duration-[.5s] ease-in-out group-hover:scale-[1.05] group-hover:text-text-2" />
                </div>
            ))}
        </div>
    )
