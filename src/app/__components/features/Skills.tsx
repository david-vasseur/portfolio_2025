...
function Skills({ title, icons }: { title: string, icons: IconType[] }) {
    ...
    return (
        <div className=" w-[30vw] flex flex-col justify-center items-center gap-2 2xl:gap-4">
            <h3 className="p-1 xl:p-2 text-md md:text-lg 2xl:text-3xl text-text-2 font-black border-b-1 border-b-text-2 border-l-1 border-l-text-2 shadow-subtitle">{title}</h3>
