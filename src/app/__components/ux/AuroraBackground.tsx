...
export const AuroraBackground = ({
  ...
  return (
    <main>
      <div
        className={cn(
          "transition-bg relative flex h-[100vh] flex-col items-center justify-center bg-zinc-50 text-slate-950 dark:bg-[var(--background)]",
          className,
        )}
        {...props}
      >
        <div
            ...
            style={{
                ...
                "--white-gradient":
                    "repeating-linear-gradient(100deg,#D9D6E8_0%,#D9D6E8_7%,transparent_10%,transparent_12%,#D9D6E8_16%)",
